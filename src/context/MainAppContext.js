...
export const MainAppProvider = ({children}) => {
  ...
  return(
    <MainAppContext.Provider value={{connectWallet, appView, participant, deployBidder, deployCreator, accountBal, setAccountBal, account, accountAddr}}>
      {children}
