...
const CreateNFT = ({ deployContract }) => {
  ...
  const handleSubmit = () => {
    deployContract(
      {
        basePrice: Reach.bigNumberToNumber(Reach.parseCurrency(basePrice)) ,
  ...
  return (
    <div className="antaliased">
      <div className="flex w-full bg-slate-900 min-h-screen justify-center items-center">
        <div className="flex flex-col space-y-6 bg-slate-500 w-50% maw-w-4xl p-8 rounded-xl shadow-lg teal-white">
          ...
          <div>
            <div className="bg-white rounded-xl shadow-lg p-8 ">
              ...
              <div>
                <button
                  className="inline-block self-end bg-cyan-700 text-white font-bold rounded-lg px-6 py-2 uppercase text-sm my-4"
