...
exports.ConnectWallet = ({connectWallet}) => {
  ...
  return (
    <div>
      <div className="w-full h-screen bg-slate-800 flex flex-col justify-between text-white">
        <div className="grid md:grid-cols-2 mx-w-[1240px] m-auto">
          <div>
            <img className="w-full" src={bgImg} alt="nft" />
          </div>
          <div className="flex flex-col justify-center md:items-center -ful px-2 py-8">
            <p className="text-2xl">World Auction Starts</p>
            <h1 className="py-3 text-5xl md:text-7xl font-bold">NFTXALG</h1>
            <p className="text-1xl">
              {" "}
              Welcome to the best NFT Minting and Biding Website
            </p>
            <button className="py-3 px-8 my-4 flex bg-cyan-700 text-white font-bold rounded-lg " onClick={connectWallet}>
              Get Started
            </button>
          </div>
